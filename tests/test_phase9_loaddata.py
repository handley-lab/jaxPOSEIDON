...
def test_init_instrument_matches_poseidon_NIRSpec_PRISM():
    ...
    ours = _loaddata.init_instrument(wl, wl_data, half_width,
                                      "JWST_NIRSpec_PRISM")
...
@pytest.mark.parametrize("offset_kwargs", [
    {},
...
def test_load_data_matches_poseidon(offset_kwargs):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        ours = _loaddata.load_data(tmpdir, names, instruments, wl_model,
                                    **offset_kwargs)
        theirs = p_load_data(tmpdir, names, instruments, wl_model,
                             **offset_kwargs)
